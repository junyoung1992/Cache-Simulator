...
: max_contexts(1),
	...
	itlb(NULL), dtlb(NULL),
	cache_dstr(NULL), cache_istr(NULL),
...
: id(rhs.id), max_contexts(rhs.max_contexts), power(rhs.power),
	...
	cache_dstr(rhs.cache_dstr), cache_istr(rhs.cache_istr),
	...
	cache_dstr_lat(rhs.cache_dstr_lat), cache_istr_lat(rhs.cache_istr_lat),
	...
	cache_dstr_opt(rhs.cache_dstr_opt), cache_istr_opt(rhs.cache_istr_opt),
