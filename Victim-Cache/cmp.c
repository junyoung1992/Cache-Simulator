...
: max_contexts(1),
	...
	cache_dvic(NULL), cache_ivic(NULL),		//Victim cache
...
: id(rhs.id), max_contexts(rhs.max_contexts), power(rhs.power),
	...
	cache_dvic(rhs.cache_dvic), cache_ivic(rhs.cache_ivic),		//Victim cache
	...
	cache_dvic_lat(rhs.cache_dvic_lat), cache_ivic_lat(rhs.cache_ivic_lat),		//Victim cache latencies
	...
	cache_dvic_opt(rhs.cache_dvic_opt), cache_ivic_opt(rhs.cache_ivic_opt), 	//Victim cache config
